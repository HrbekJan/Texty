...
\includegraphics[width=5cm]{Geometrie_prvniho_problemu.png}
...
\includegraphics[width=6cm]{Vypocet_indukcnosti.png}
\includegraphics[width=6cm]{Silocary.png}\\
\includegraphics[width=6cm]{Vektory.png}\\
